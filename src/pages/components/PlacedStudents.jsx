...
const PlacedStudents = () => {
  ...
  return (
    <section className="placed_students_section">
          ...
          <div className="carousel-main">
            ...
            >
              ...
              <div className="student-info">
                ...
                <p className="student-role"><span className="highlight_title">UI/UX Designer </span> at Sofwavetech</p>
              </div>
            </div>
          </div>
        ))}
      ...
      {/* Navigation Buttons */}
      {/* <button className="carousel-nav left" onClick={() => handleSlide("left")}>
        &#8249;
      </button>
      <button
